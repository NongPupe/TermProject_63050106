...
public class Database {
    ...
    public static void main (String []args) throws FileNotFoundException, JSONException {
        JsonReader reader = Json.createReader(new FileReader("C:\\Users\\NongPupe\\Documents\\Y3T1\\Component\\Term_project\\covid_data.txt"));
        ...
        for(int i = 0; i < arr.length(); i++) {
            ...
            Covidnoi cov = new Covidnoi(yearnum, weeknum, new_case, total_case, new_case_excludeabroad, total_case_excludeabroad,
